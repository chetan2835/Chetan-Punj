...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "784a82d7-4980-48ae-9f3f-46feb9243fa4"); // Replace with your Web3Forms access key
...
<br />
                <div className="flex gap-6 mt-3">
                  <a
                    href="https://www.linkedin.com/in/chetan-punj/"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/chetan2835"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 text-4xl hover:scale-110 transition"
                  >
                    <FaGithub />
                  </a>

                  <a
                    href="mailto:chetanpunj481@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
